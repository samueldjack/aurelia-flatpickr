...
System.register(['aurelia-framework', 'flatpickr', 'flatpickr/dist/flatpickr.css'], function (_export, _context) {
    "use strict";

    var inject, bindable, bindingMode, Flatpickr, _dec, _dec2, _class, _desc, _value, _class2, _descriptor, _descriptor2, defaultConfig, AureliaFlatpickrCustomElement;
    ...
    return {
        ...
        }, function (_flatpickrDistFlatpickrCss) {}],
        execute: function () {
            defaultConfig = {
                enableTime: true,
                altInput: true,
