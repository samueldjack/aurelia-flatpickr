System.config({
  ...
  map: {
    ...
    "aurelia-tools": "npm:aurelia-tools@0.2.4",
    ...
    "babel-plugin-transform-es2015-modules-commonjs": "npm:babel-plugin-transform-es2015-modules-commonjs@6.23.0",
    ...
    "babel-preset-es2015-loose": "npm:babel-preset-es2015-loose@7.0.0",
    ...
    "gulp-bump": "npm:gulp-bump@2.7.0",
    "gulp-eslint": "npm:gulp-eslint@3.0.1",
    "gulp-yuidoc": "npm:gulp-yuidoc@0.1.2",
    "isparta": "npm:isparta@4.0.0",
    "istanbul": "npm:istanbul@1.0.0-alpha.2",
    "jasmine-core": "npm:jasmine-core@2.5.2",
    "karma": "npm:karma@1.5.0",
    "karma-babel-preprocessor": "npm:karma-babel-preprocessor@6.0.1",
    "karma-chrome-launcher": "npm:karma-chrome-launcher@1.0.1",
    ...
    "require-dir": "npm:require-dir@0.3.1",
    ...
    "npm:babel-plugin-transform-es2015-modules-commonjs@6.23.0": {
    ...
    "npm:babel-plugin-transform-es2015-modules-umd@6.23.0": {
      "babel-plugin-transform-es2015-modules-amd": "npm:babel-plugin-transform-es2015-modules-amd@6.22.0",
      "babel-runtime": "npm:babel-runtime@6.23.0",
      "babel-template": "npm:babel-template@6.23.0",
      "path": "github:jspm/nodelibs-path@0.1.0"
    ...
    "npm:babel-preset-es2015-loose@7.0.0": {
      "babel-preset-es2015": "npm:babel-preset-es2015@6.22.0",
      "modify-babel-preset": "npm:modify-babel-preset@1.2.0"
    },
    "npm:babel-preset-es2015@6.22.0": {
      ...
      "babel-plugin-transform-es2015-modules-commonjs": "npm:babel-plugin-transform-es2015-modules-commonjs@6.23.0",
      "babel-plugin-transform-es2015-modules-systemjs": "npm:babel-plugin-transform-es2015-modules-systemjs@6.23.0",
      "babel-plugin-transform-es2015-modules-umd": "npm:babel-plugin-transform-es2015-modules-umd@6.23.0",
    ...
    "npm:babel-register@6.23.0": {
      "babel-core": "npm:babel-core@6.23.1",
      "babel-runtime": "npm:babel-runtime@6.23.0",
    ...
    "npm:conventional-changelog-angular@1.3.0": {
      "compare-func": "npm:compare-func@1.3.2",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "github-url-from-git": "npm:github-url-from-git@1.5.0",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "q": "npm:q@1.4.1"
    },
    ...
    "npm:conventional-changelog-core@1.5.0": {
      ...
      "conventional-commits-parser": "npm:conventional-commits-parser@1.3.0",
      "dateformat": "npm:dateformat@1.0.12",
      "get-pkg-repo": "npm:get-pkg-repo@1.3.0",
    ...
    "npm:conventional-changelog@1.1.0": {
      "conventional-changelog-angular": "npm:conventional-changelog-angular@1.3.0",
    ...
    "npm:conventional-commits-parser@1.3.0": {
      "JSONStream": "npm:JSONStream@1.3.0",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      ...
      "split2": "npm:split2@2.1.1",
      "through2": "npm:through2@2.0.3",
      "trim-off-newlines": "npm:trim-off-newlines@1.0.1"
    },
    ...
    "npm:get-pkg-repo@1.3.0": {
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "hosted-git-info": "npm:hosted-git-info@2.2.0",
      "meow": "npm:meow@3.7.0",
      "normalize-package-data": "npm:normalize-package-data@2.3.5",
      "parse-github-repo-url": "npm:parse-github-repo-url@1.4.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "systemjs-json": "github:systemjs/plugin-json@0.1.2",
      "through2": "npm:through2@2.0.3",
      "url": "github:jspm/nodelibs-url@0.1.0",
    ...
    "npm:gulp-bump@2.7.0": {
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
      "bump-regex": "npm:bump-regex@2.7.0",
      "path": "github:jspm/nodelibs-path@0.1.0",
    ...
    "npm:gulp-eslint@3.0.1": {
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
      "bufferstreams": "npm:bufferstreams@1.1.1",
      "eslint": "npm:eslint@3.16.1",
      "gulp-util": "npm:gulp-util@3.0.8",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "stream": "github:jspm/nodelibs-stream@0.1.0"
    ...
    "npm:is-text-path@1.0.1": {
      "path": "github:jspm/nodelibs-path@0.1.0",
      "text-extensions": "npm:text-extensions@1.4.0"
    },
    ...
    "npm:isparta@4.0.0": {
      ...
      "mkdirp": "npm:mkdirp@0.5.1",
      "module": "github:jspm/nodelibs-module@0.1.0",
      "nomnomnomnom": "npm:nomnomnomnom@2.0.1",
      "object-assign": "npm:object-assign@4.1.0",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "source-map": "npm:source-map@0.5.6",
    ...
    "npm:istanbul-api@1.1.1": {
      "async": "npm:async@2.1.5",
      "fileset": "npm:fileset@2.0.3",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "istanbul-lib-coverage": "npm:istanbul-lib-coverage@1.0.1",
      "istanbul-lib-hook": "npm:istanbul-lib-hook@1.0.0",
      "istanbul-lib-instrument": "npm:istanbul-lib-instrument@1.4.2",
      "istanbul-lib-report": "npm:istanbul-lib-report@1.0.0-alpha.3",
      "istanbul-lib-source-maps": "npm:istanbul-lib-source-maps@1.1.0",
      "istanbul-reports": "npm:istanbul-reports@1.0.1",
      "js-yaml": "npm:js-yaml@3.8.1",
      "mkdirp": "npm:mkdirp@0.5.1",
      "once": "npm:once@1.4.0",
      "path": "github:jspm/nodelibs-path@0.1.0",
    ...
    "npm:istanbul-lib-hook@1.0.0": {
      "append-transform": "npm:append-transform@0.4.0",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "vm": "github:jspm/nodelibs-vm@0.1.0"
    },
    "npm:istanbul-lib-instrument@1.4.2": {
      "babel-generator": "npm:babel-generator@6.23.0",
      "babel-template": "npm:babel-template@6.23.0",
      "babel-traverse": "npm:babel-traverse@6.23.1",
      "babel-types": "npm:babel-types@6.23.0",
    ...
    "npm:istanbul-lib-report@1.0.0-alpha.3": {
      "async": "npm:async@1.5.2",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "istanbul-lib-coverage": "npm:istanbul-lib-coverage@1.0.1",
      "mkdirp": "npm:mkdirp@0.5.1",
    ...
    "npm:istanbul-lib-source-maps@1.1.0": {
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "istanbul-lib-coverage": "npm:istanbul-lib-coverage@1.0.1",
      "mkdirp": "npm:mkdirp@0.5.1",
    ...
    "npm:istanbul@1.0.0-alpha.2": {
      "abbrev": "npm:abbrev@1.0.9",
      "async": "npm:async@1.5.2",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "istanbul-api": "npm:istanbul-api@1.1.1",
      "js-yaml": "npm:js-yaml@3.8.1",
      "mkdirp": "npm:mkdirp@0.5.1",
      "module": "github:jspm/nodelibs-module@0.1.0",
      "nopt": "npm:nopt@3.0.6",
    ...
    "npm:karma-chrome-launcher@1.0.1": {
    ...
    "npm:modify-babel-preset@1.2.0": {
      "path": "github:jspm/nodelibs-path@0.1.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "require-relative": "npm:require-relative@0.8.7"
    },
    "npm:multipipe@0.1.2": {
    ...
    "npm:parse-github-repo-url@1.4.0": {
      "url": "github:jspm/nodelibs-url@0.1.0"
    },
